...
def canny_points(edges, points_num=100):
    ...
    while count < points_num:
        ...
        if edges[axis_h[0], axis_w[0]] > 1:
            ...
            edges[axis_h[0]-1:axis_h[0]+1, axis_w[0]-1:axis_w[0]+1] = 0
...
for i in range(1,int(sys.argv[3])+1):
    ...
    if total < total_min:
        total_min = total
        index_min = i
        #print(imageB_path,'Shape:',i)
        #break
if total_min < 1000:
    print(imageB_path, 'Shape:', index_min,'cost',total_min)
else:
    print(imageB_path,'No shape found',index_min,'cost',total_min)
